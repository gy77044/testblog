    ...
    <div className="w-full h-[80px] z-10 bg-white fixed drop-shadow-lg relative">
      <div className="flex justify-between items-center w-full h-full md:max-w-[1240px] m-auto">
        <div className="flex items-center">
          <b className="ml-10 sm:ml-10 ss:ml-10 md:ml-3 opacity-[55%] w-full h-[25px]">
            TestBlog
          </b>
        </div>
      ...
      >
        ...
        <div className="flex flex-col my-4">
          <button className="bg-transparent text-black mb-4 py-3 px-8 outline-none border-none">
            Login
          </button>
          <button className="px-8 py-3">Sign Up</button>
        </div>
