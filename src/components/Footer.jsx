...
const Footer = () => {
  return (
    <div className="w-full bottom-0 bg-[#02044A] text-gray-300 py-8 px-2">
      <div className="max-w-[1240px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8">
        <div>
          <h6 className="font-bold uppercase py-2">test</h6>
          <ol>
        ...
        <div>
          <h6 className="font-bold uppercase py-2">Community</h6>
          <ol>
            <li className="py-1">test</li>
            <li className="py-1">test</li>
            <li className="py-1">test</li>
